...
import { Autocomplete, Button, Chip, CircularProgress, Stack, TextField, Typography } from '@mui/material'
                ...
                <div className='container mx-40 mb-32'>
                    <>
                        ...
                        <Typography
                            ...
                            fontWeight={'bold'} marginBottom={'1rem'} >Edit Post </Typography>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <Stack spacing={2}>
                                ...
                                <Controller
                                    ...
                                    control={control}
                                    rules={{
                                        required: { value: true, message: 'links are required' },
                                        pattern: {
                                            value: /^https?:\/\/(?:www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b(?:[-a-zA-Z0-9()@:%_\+.~#?&\/=]*)$/,
                                            message: 'the input pust be a link'
                                        }
                                    }}
                                    render={({ field, fieldState: { invalid, error } }) => (
                                        <Autocomplete
