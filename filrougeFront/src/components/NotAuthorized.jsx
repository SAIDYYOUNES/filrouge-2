...
//     if (role === 'syndic') window.location.href = '/home'
//   }
//   setTimeout(() => {
//    redirect()
//   }, 5000)
  return (
    <div className='body'>
      <div id="container">
        ...
        <div class="toph"><h1>ERROR </h1><h1 class="number">403</h1>
        <h2 className='text-white text-3xl'>Go back now , or you get redirected automaticly</h2>
        <button onClick={redirect} class="bg-white text-black  mt-8  font-bold py-1 px-4 rounded text-center" type="button">click here</button>
        </div>
